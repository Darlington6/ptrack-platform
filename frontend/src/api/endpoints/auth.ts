...
export const authApi = {
  ...
  register: (payload: RegisterRequest) =>
    client.post<AuthTokens>('/auth/register/', payload),

  me: () => client.get<User>('/auth/me/'),

  updateMe: (data: Partial<Pick<User, 'bio' | 'preferred_language' | 'theme_preference' | 'weekly_goal' | 'show_on_leaderboard' | 'allow_public_reports' | 'notification_preferences'>>) =>
